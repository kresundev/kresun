...
class AreaPickerPage extends ConsumerStatefulWidget {
  const AreaPickerPage({super.key, required this.regionId});
...
class _AreaPickerPageState extends ConsumerState<AreaPickerPage> {
  ...
  Widget build(BuildContext context) {
    final areasAsync = ref.watch(areasByRegionProvider(widget.regionId));
          ...
          Expanded(
            child: areasAsync.when(
              data: (areas) {
                ...
                if (filtered.isEmpty) {
                  return const _EmptyState(message: 'Wilayah tidak ditemukan');
                }
